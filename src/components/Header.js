...
import logo from "../assets/44460.png";
...
export const Header = () => {
  ...
  return (
    <header>
      ...
      <nav className="bg-emerald-600 border-gray-600 px-2 sm:px-4 py-2.5 dark:bg-gray-900">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          <Link to="/" className="flex items-center">
            <img src={logo} className="h-6 mr-3 sm:h-9" alt="MyCineList Logo" />
            <span className="self-center text-xl font-bold whitespace-nowrap text-white">MyCineList</span>
          </Link>
